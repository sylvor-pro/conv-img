...
import { ConvImgProvider } from "./ConvImgContext";
...
export default function Home() {
  ...
  // Initialize history, including initial state
  ...
  return (
    <ConvImgProvider onDownload={handleDownload}>
      <div className="flex flex-col lg:flex-row h-screen max-h-screen">
        ...
        {/* Center content area - auto fill remaining space */}
